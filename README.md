...
시스템 설계, 에디터 툴 개발, 렌더링 구조 설계를 주로 다룹니다.

📧 [silsen@naver.com](mailto:silsen@naver.com)
...
| [unity-mvvm](https://github.com/Frenil-client/unity-mvvm) | UI 시스템 | Unity UGUI 환경을 위한 경량 MVVM 프레임워크. Observable 기반 데이터 바인딩, 외부 라이브러리 없이 구현 |
